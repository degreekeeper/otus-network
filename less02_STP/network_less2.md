...
[spoiler]Топология и таблица[/![table](https://github.com/degreekeeper/otus-network/blob/master/less02_STP/Screenshot_1.jpg "таблица")]
...
**Заблокированный порт на S3 стал назначенным, т.к. его стоимость до рута стала 18(0+18). Заблокировался порт S2 eth0/2 т.к. его стоимость осталась 100(0+100) и сейчас это самая большая стоимость до root.**
...
**На S3 порт root изменился с 1/0 на 0/3, т.к его BID меньше, за счёт меньшего номера порта - 4 вместо 5 у прежнего порта 1/0**
